...
const products = [
  ...
  { id: 25, name: "Deli Gloves (Pack of 100)", category: "ppe", slug: "gloves", description: "Lightweight, disposable food-handling gloves designed to provide a hygienic barrier between hands and food products.", image: "images/Deli-Gloves.png", unit: "()100's)", sku: "DGL-007", price: "R 15.49", featured: true, features: ["Food-Safe Material", "Disposable Single-Use Design", "Pack of 100 Gloves", "Ambidextrous Fit", "Lightweight & Comfortable", "Easy to Put On & Remove", "Latex-Free"] },
  { id: 26, name: "SA10 Reflective Safety Vest – Various Sizes", category: "ppe", slug: "covers", description: "High-visibility personal protective garment designed to improve worker safety in low-light, high-traffic, and hazardous environments.", image: "images/Reflective-Vest.png", unit: "each", sku: "SRV-005", price: "R 79.49", featured: true, features: ["High-Visibility Design", "Reflective Tape", "Lightweight & Breathable", "Durable Construction", "Front Closure", "Various Sizes Available", "Comfortable Fit"] },
