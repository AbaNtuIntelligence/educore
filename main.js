...
const products = [
  ...
  { id: 33, name: "55cm Mustik Double Blade Floor Squeegee Only", category: "cleaning", slug: "floor-sweeper", description: "Heavy-duty cleaning tool designed for the fast and efficient removal of water, spills, cleaning solutions, and other liquids from a wide variety of floor surfaces.", image: "images/blade.jpg", unit: "each", sku: "BLD-007", price: "R 450.00", featured: true, features: ["55cm Wide Cleaning Head", "Double Rubber Blade Design", "Heavy-Duty Construction", "Effective Liquid Removal", "Suitable for Multiple Floor Types", "Easy Handle Attachment", "Low Maintenance"] },
