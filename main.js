...
const products = [
  ...
  { id: 33, name: "55cm Mustik Double Blade Floor Squeegee Only", category: "cleaning", slug: "floor-sweeper", description: "Heavy-duty cleaning tool designed for the fast and efficient removal of water, spills, cleaning solutions, and other liquids from a wide variety of floor surfaces.", image: "images/imguri.jpg", unit: "each", sku: "BLD-007", price: "R 450.00", featured: true, features: ["55cm Wide Cleaning Head", "Double Rubber Blade Design", "Heavy-Duty Construction", "Effective Liquid Removal", "Suitable for Multiple Floor Types", "Easy Handle Attachment", "Low Maintenance"] },
  ...
  { id: 39, name: "Multiputpode Cleaning Solution 5L", category: "cleaning", slug: "all-purpose", description: "Premium two-in-one vehicle cleaning solution that effectively washes and protects your vehicle in a single application.", image: "images/All-Purpose5l.jpg", unit: "EA", sku: "APC-003", price: "R 186.99", featured: true, features: ["Powerful Cleaning Action", "Enhanced Gloss Finish", "High-Foaming Formula", "A4 Document Compatibility", "Easy to Use", "Pleasant Fragrance"]  },
  { id: 40, name: "Heavy-Duty Degreaser Cleaner – 5L", category: "cleaning", slug: "cleaning", description: "Powerful, professional-grade cleaning solution formulated to cut through stubborn grease, oil, grime, carbon deposits, and industrial dirt with ease.", image: "images/Gloves-Yellow.png", unit: "EA", sku: "DGR-005", price: "R 536.99", featured: true, features: ["Powerful Degreasing Formula", "Powerful Degreasing Formula", "Professional-Grade Performance", "Concentrated 5L Solution", "Multi-Surface Compatibility", "Fast-Acting Formula", "Low-Residue Finish", "Easy Application", "Large 5L Capacity"] },
